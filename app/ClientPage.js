...
const categories = [
    { name: 'Plastic', thaiName: 'พลาสติก', icon: CoffeeIcon, color: 'bg-amber-300' },
    { name: 'Wood', thaiName: 'ไม้', icon: TeaIcon, color: 'bg-yellow-500' },
    { name: 'Glass', thaiName: 'แก้ว', icon: SmoothieIcon, color: 'bg-blue-400' },
...
const WelcomeBanner = () => (<div className="p-6 sm:p-8 bg-gradient-to-r from-lime-500 to-emerald-500 text-white rounded-xl mb-8 shadow-lg"><h2 className="text-3xl font-bold mb-2">ยินดีต้อนรับ!</h2><p className="text-lg opacity-90">สั่งเครื่องดื่มแก้วโปรดของคุณได้ง่ายๆ ที่นี่</p></div>);
